...
public class ToolMaterials {
    ...
    public static final SimpleTier AMETHYST = new SimpleTier(ModTags.INCORRECT_FOR_AMETHYST_TAG, 550, 7.0f, 2.5f, 30, () -> Ingredient.of(ModTags.AMETHYST_TAG));
    ...
    public static final SimpleTier EMERALD = new SimpleTier(ModTags.INCORRECT_FOR_EMERALD_TAG, 550, 7.0f, 3.0f, 25, () -> Ingredient.of(ModTags.EMERALD_TAG));
