...
public class ModItems {
    ...
    public static final DeferredItem<Item> AMETHYST_HELMET = ITEMS.registerItem("amethyst_helmet", props -> new Item(props.humanoidArmor(ModArmorMaterials.AMETHYST_ARMOR_MATERIAL, ArmorType.HELMET)));
    public static final DeferredItem<Item> AMETHYST_LEGGINGS = ITEMS.registerItem("amethyst_leggings", props -> new Item(props.humanoidArmor(ModArmorMaterials.AMETHYST_ARMOR_MATERIAL, ArmorType.LEGGINGS)));
    public static final DeferredItem<Item> AMETHYST_CHESTPLATE = ITEMS.registerItem("amethyst_chestplate", props -> new Item(props.humanoidArmor(ModArmorMaterials.AMETHYST_ARMOR_MATERIAL, ArmorType.CHESTPLATE)));
    public static final DeferredItem<Item> AMETHYST_BOOTS = ITEMS.registerItem("amethyst_boots", props -> new Item(props.humanoidArmor(ModArmorMaterials.AMETHYST_ARMOR_MATERIAL, ArmorType.BOOTS)));

    public static final DeferredItem<Item> RUBY_HELMET = ITEMS.registerItem("ruby_helmet", props -> new Item(props.humanoidArmor(ModArmorMaterials.RUBY_ARMOR_MATERIAL, ArmorType.HELMET)));
    public static final DeferredItem<Item> RUBY_LEGGINGS = ITEMS.registerItem("ruby_leggings", props -> new Item(props.humanoidArmor(ModArmorMaterials.RUBY_ARMOR_MATERIAL, ArmorType.LEGGINGS)));
    public static final DeferredItem<Item> RUBY_CHESTPLATE = ITEMS.registerItem("ruby_chestplate", props -> new Item(props.humanoidArmor(ModArmorMaterials.RUBY_ARMOR_MATERIAL, ArmorType.CHESTPLATE)));
    public static final DeferredItem<Item> RUBY_BOOTS = ITEMS.registerItem("ruby_boots", props -> new Item(props.humanoidArmor(ModArmorMaterials.RUBY_ARMOR_MATERIAL, ArmorType.BOOTS)));

    public static final DeferredItem<Item> SAPPHIRE_HELMET = ITEMS.registerItem("sapphire_helmet", props -> new Item(props.humanoidArmor(ModArmorMaterials.SAPPHIRE_ARMOR_MATERIAL, ArmorType.HELMET)));
    public static final DeferredItem<Item> SAPPHIRE_LEGGINGS = ITEMS.registerItem("sapphire_leggings", props -> new Item(props.humanoidArmor(ModArmorMaterials.SAPPHIRE_ARMOR_MATERIAL, ArmorType.LEGGINGS)));
    public static final DeferredItem<Item> SAPPHIRE_CHESTPLATE = ITEMS.registerItem("sapphire_chestplate", props -> new Item(props.humanoidArmor(ModArmorMaterials.SAPPHIRE_ARMOR_MATERIAL, ArmorType.CHESTPLATE)));
    public static final DeferredItem<Item> SAPPHIRE_BOOTS = ITEMS.registerItem("sapphire_boots", props -> new Item(props.humanoidArmor(ModArmorMaterials.SAPPHIRE_ARMOR_MATERIAL, ArmorType.BOOTS)));

    public static final DeferredItem<Item> TOPAZ_HELMET = ITEMS.registerItem("topaz_helmet", props -> new Item(props.humanoidArmor(ModArmorMaterials.TOPAZ_ARMOR_MATERIAL, ArmorType.HELMET)));
    public static final DeferredItem<Item> TOPAZ_LEGGINGS = ITEMS.registerItem("topaz_leggings", props -> new Item(props.humanoidArmor(ModArmorMaterials.TOPAZ_ARMOR_MATERIAL, ArmorType.LEGGINGS)));
    public static final DeferredItem<Item> TOPAZ_CHESTPLATE = ITEMS.registerItem("topaz_chestplate", props -> new Item(props.humanoidArmor(ModArmorMaterials.TOPAZ_ARMOR_MATERIAL, ArmorType.CHESTPLATE)));
    public static final DeferredItem<Item> TOPAZ_BOOTS = ITEMS.registerItem("topaz_boots", props -> new Item(props.humanoidArmor(ModArmorMaterials.TOPAZ_ARMOR_MATERIAL, ArmorType.BOOTS)));

    public static final DeferredItem<Item> CRYSTAL_HELMET = ITEMS.registerItem("crystal_helmet", props -> new Item(props.humanoidArmor(ModArmorMaterials.CRYSTAL_ARMOR_MATERIAL, ArmorType.HELMET)));
    public static final DeferredItem<Item> CRYSTAL_LEGGINGS = ITEMS.registerItem("crystal_leggings", props -> new Item(props.humanoidArmor(ModArmorMaterials.CRYSTAL_ARMOR_MATERIAL, ArmorType.LEGGINGS)));
    public static final DeferredItem<Item> CRYSTAL_CHESTPLATE = ITEMS.registerItem("crystal_chestplate", props -> new Item(props.humanoidArmor(ModArmorMaterials.CRYSTAL_ARMOR_MATERIAL, ArmorType.CHESTPLATE)));
    public static final DeferredItem<Item> CRYSTAL_BOOTS = ITEMS.registerItem("crystal_boots", props -> new Item(props.humanoidArmor(ModArmorMaterials.CRYSTAL_ARMOR_MATERIAL, ArmorType.BOOTS)));

    public static final DeferredItem<Item> EMERALD_HELMET = ITEMS.registerItem("emerald_helmet", props -> new Item(props.humanoidArmor(ModArmorMaterials.EMERALD_ARMOR_MATERIAL, ArmorType.HELMET)));
    public static final DeferredItem<Item> EMERALD_LEGGINGS = ITEMS.registerItem("emerald_leggings", props -> new Item(props.humanoidArmor(ModArmorMaterials.EMERALD_ARMOR_MATERIAL, ArmorType.LEGGINGS)));
    public static final DeferredItem<Item> EMERALD_CHESTPLATE = ITEMS.registerItem("emerald_chestplate", props -> new Item(props.humanoidArmor(ModArmorMaterials.EMERALD_ARMOR_MATERIAL, ArmorType.CHESTPLATE)));
    public static final DeferredItem<Item> EMERALD_BOOTS = ITEMS.registerItem("emerald_boots", props -> new Item(props.humanoidArmor(ModArmorMaterials.EMERALD_ARMOR_MATERIAL, ArmorType.BOOTS)));
